              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        l10n.translate('review_vehicles'),
                      ...
                      Text(
                        l10n.translate('review_vehicles_subtitle'),
                        style: const TextStyle(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        '${vehicles.length} ${l10n.translate('vehicle_count_suffix_single')}',
                        style: const TextStyle(
                          color: Colors.white70,
                              ...
                              children: [
                                Expanded(
                                  child: FilledButton(
                                    ...
                                    child: Text(l10n.translate('approve')),
                                  ),
                                ),
                                const SizedBox(width: 10),
                                Expanded(
